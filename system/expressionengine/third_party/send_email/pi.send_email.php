...
class Send_email {
	...
	function Send_email($str = '')
	{
		...
		else
		{
			...
			$message = str_replace("* Responsabilidad Civil : S/. No Contratado mensuales.<br>", " ", $message);	
			$message = str_replace("* Pérdida por robo : S/. No Contratado mensuales.<br>", "", $message);	
			$message = str_replace("* Pérdida por choque :  S/. No Contratado mensuales.<br>", "", $message);	
			$message = str_replace("* Daños propios por choque : S/. No Contratado mensuales.<br>", "", $message);	
			// Send email
